...
def main(name_file):
	...
	global instructions
	global data
	#for num,command in enumerate(open(os.getcwd()+'/src/bert2_simulator/scripts/'+name_file+'.txt','r')): #ADD READING FILE
	for num,command in enumerate(open(os.getcwd()+'/bert2_simulator/scripts/'+name_file+'.txt','r')): #ADD READING FILE
